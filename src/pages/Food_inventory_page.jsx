        ...
        <tbody>
          ...
          {sortedItems.map((food) => (
            <tr key={food.id}>
              ...
              <td>
                 {food["Expiration Date"] && typeof food["Expiration Date"].toDate === 'function' ? 
                  food["Expiration Date"].toDate().toLocaleDateString() : 
              ...
              <td>
                  {isEditingId == food.id ? (
                    <>
                      <button onClick={() => handleSaveChange(food.id)}>Save Change</button>
                      <button onClick={handleCancelChange}>Cancel</button>
                    </>
                  ) : (
                    <button onClick={() => setIsEditingId(food.id)}>Edit</button>
                  )}
              </td>
              <td>{isEditingId == food.id ? (
              <input
                type="date"
                value={newDate}
